...
def ogrod( S, V ):
    ...
    for a in range(n):
        ...
        for b in range(a,n): #rozszerzam przedział
            money = max(money , temp_money) #okno poprawne sprawdzam max
            ...
            # elif taken[S[b]] == OVERPICKED: pass 
            # #pomijam bo za duzo i tak ich jest w oknie
...
runtests(ogrod2, all_tests = True)